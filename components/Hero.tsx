    ...
    <section id="hero" className="ms" style={{ ['--ms-url' as string]: "url('/img/hangul-papers.jpg')" }}>
      <div className="hero-grid">
        ...
        <div>
          ...
          <div className="srow">
            <a href="https://linkedin.com/in/aaronsnowberger/" className="slink sl-t fs" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://github.com/jekkilekki" className="slink sl-t fs" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="currentColor" width="13" height="13">
                <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 00-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0020 4.77 5.07 5.07 0 0019.91 1S18.73.65 16 2.48a13.38 13.38 0 00-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 005 4.77a5.44 5.44 0 00-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 009 18.13V22"/>
              </svg>
              GitHub
            </a>
            <a href="https://www.researchgate.net/profile/Aaron-Snowberger" className="slink sl-b fs" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="currentColor" width="13" height="13">
            ...
            <a href="https://scholar.google.com/citations?user=JCbnnvUAAAAJ" className="slink sl-b fs" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="currentColor" width="13" height="13">
            ...
            <a href="https://orcid.org/0000-0001-8652-0936" className="slink sl-p fs" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="currentColor" width="13" height="13">
            ...
            <a href="https://kspai.org" className="slink sl-p fs" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="13" height="13">
                <path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/>
              </svg>
              KSPAI
            </a>
            <a href="mailto:hi@aaron.kr" className="slink sl-pk fs">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="13" height="13">
