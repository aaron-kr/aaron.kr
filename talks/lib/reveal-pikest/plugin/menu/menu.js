		...
		if (!head.browser.ie || head.browser.version >= 9) {
			...
			if (typeof themes === "undefined") {
				themes = [
					...
					{ name: 'Alley', theme: 'css/theme/alley.css' },
					{ name: 'Ember', theme: 'css/theme/ember.css' },
					{ name: 'Knightlab', theme: 'css/theme/knightlab.css' },
					{ name: 'Moz-Light', theme: 'css/theme/moz-light.css' },
					{ name: 'Moz-Dark', theme: 'css/theme/moz-dark.css' },
					{ name: 'Pike Street', theme: 'css/theme/pikestreet.css' }
				];
			}
